...
public class TowerBulletBehavior : MonoBehaviour
{
    ...
    //----------------------------------------------------------------------- Переданные параметры улучшений башни
    ...
    //----------------------------------------------------------------------- Инкапсуляция _ переменные улучшений
    ...
    //----------------------------------------------------------------------- Методы от подписок TowerBehavior
    #region From Subscription
