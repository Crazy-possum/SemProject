...
public static class TutorController
{
    ...
    private static void UpdateTutor(string stage)
    {
        ...
        {
            SetTutorStage(TutorEnum.EnemyNearTowerPoint, false);
        ...
        {
            SetTutorStage(TutorEnum.EnemyNearTowerPoint, true);
        ...
        {
            SetTutorStage(TutorEnum.FirstTowerStrike, false);
        ...
        {
            SetTutorStage(TutorEnum.AllEnemiesKilled, true);
        ...
        {
            SetTutorStage(TutorEnum.SelectSecondLevel, false);
        ...
        {
            SetTutorStage(TutorEnum.SelectSecondLevel, true);
        ...
        {
            SetTutorStage(TutorEnum.TowerInSecondLevel, false);
        ...
        {
            SetTutorStage(TutorEnum.TowerInSecondLevel, true);
    ...
    public static void SetTutorStage(TutorEnum tutorEnum, bool isTutorStageDone)
    {
